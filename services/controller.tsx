  ...
  async *processRequest(
    ...
    while (attempts < maxAttempts) {
      ...
      try {
        ...
        const filesToValidateBeforeApply = allGeneratedFiles;
        const preApplyValidationErrors = this.validator.validateOutput(filesToValidateBeforeApply, currentContextFiles, this.dependencyGraph, currentPrompt);
