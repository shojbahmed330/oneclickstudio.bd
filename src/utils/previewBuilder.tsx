...
export const buildFinalHtml = (projectFiles: Record<string, string>, entryPath: string = 'index.html', projectConfig?: any, useDataUri: boolean = false) => {
  try {
    ...
    const importMap: Record<string, string> = {
      ...
      "admin/": "/admin/",
      "src/": "/src/",
      "@/": Object.keys(projectFiles).some(f => f.startsWith('src/')) ? "/src/" : "/app/",
      ...
      "react-dom/server": "https://esm.sh/react-dom@18.3.1/server?deps=react@18.3.1",

      // ✅ Routing
      "react-router": "https://esm.sh/react-router@6.28.0?deps=react@18.3.1,react-dom@18.3.1",
      "react-router-dom": "https://esm.sh/react-router-dom@6.28.0?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ UI Icons
      "lucide-react": "https://esm.sh/lucide-react@0.563.0?deps=react@18.3.1,react-dom@18.3.1",
      "react-icons": "https://esm.sh/react-icons@5.4.0?deps=react@18.3.1,react-dom@18.3.1",
      ...
      // ✅ Animation
      "framer-motion": "https://esm.sh/framer-motion@11.11.11?deps=react@18.3.1,react-dom@18.3.1",
      "motion/react": "https://esm.sh/framer-motion@11.11.11?deps=react@18.3.1,react-dom@18.3.1",
      "react-spring": "https://esm.sh/react-spring@9.7.5?deps=react@18.3.1,react-dom@18.3.1",
      "@react-spring/web": "https://esm.sh/@react-spring/web@9.7.5?deps=react@18.3.1,react-dom@18.3.1",
      ...
      "react-chartjs-2": "https://esm.sh/react-chartjs-2@5.2.0?deps=react@18.3.1,react-dom@18.3.1",
      "d3": "https://esm.sh/d3@7.9.0",
      "victory": "https://esm.sh/victory@37.3.2?deps=react@18.3.1,react-dom@18.3.1",
      "nivo": "https://esm.sh/@nivo/core@0.87.0?deps=react@18.3.1,react-dom@18.3.1",
      "@nivo/bar": "https://esm.sh/@nivo/bar@0.87.0?deps=react@18.3.1,react-dom@18.3.1",
      "@nivo/line": "https://esm.sh/@nivo/line@0.87.0?deps=react@18.3.1,react-dom@18.3.1",
      "@nivo/pie": "https://esm.sh/@nivo/pie@0.87.0?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ State Management
      "zustand": "https://esm.sh/zustand@4.5.5?bundle&deps=react@18.3.1,react-dom@18.3.1",
      ...
      "react-redux": "https://esm.sh/react-redux@9.2.0?deps=react@18.3.1,react-dom@18.3.1",
      "mobx": "https://esm.sh/mobx@6.13.5",
      "mobx-react-lite": "https://esm.sh/mobx-react-lite@4.1.0?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ Forms & Validation
      "react-hook-form": "https://esm.sh/react-hook-form@7.54.0?deps=react@18.3.1,react-dom@18.3.1",
      "@hookform/resolvers": "https://esm.sh/@hookform/resolvers@3.9.1",
      "zod": "https://esm.sh/zod@3.24.0",
      "yup": "https://esm.sh/yup@1.6.1",
      "formik": "https://esm.sh/formik@2.4.6?deps=react@18.3.1,react-dom@18.3.1",
      ...
      "styled-components": "https://esm.sh/styled-components@6.1.13?deps=react@18.3.1,react-dom@18.3.1",
      "@emotion/react": "https://esm.sh/@emotion/react@11.14.0?deps=react@18.3.1,react-dom@18.3.1",
      "@emotion/styled": "https://esm.sh/@emotion/styled@11.14.0?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ UI Component Libraries
      "@radix-ui/react-dialog": "https://esm.sh/@radix-ui/react-dialog@1.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-dropdown-menu": "https://esm.sh/@radix-ui/react-dropdown-menu@2.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-tooltip": "https://esm.sh/@radix-ui/react-tooltip@1.1.6?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-popover": "https://esm.sh/@radix-ui/react-popover@1.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-tabs": "https://esm.sh/@radix-ui/react-tabs@1.1.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-accordion": "https://esm.sh/@radix-ui/react-accordion@1.2.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-checkbox": "https://esm.sh/@radix-ui/react-checkbox@1.1.3?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-switch": "https://esm.sh/@radix-ui/react-switch@1.1.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-slider": "https://esm.sh/@radix-ui/react-slider@1.2.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-select": "https://esm.sh/@radix-ui/react-select@2.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-avatar": "https://esm.sh/@radix-ui/react-avatar@1.1.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-badge": "https://esm.sh/@radix-ui/react-badge@1.0.0?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-progress": "https://esm.sh/@radix-ui/react-progress@1.1.1?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-toast": "https://esm.sh/@radix-ui/react-toast@1.2.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-alert-dialog": "https://esm.sh/@radix-ui/react-alert-dialog@1.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-separator": "https://esm.sh/@radix-ui/react-separator@1.1.1?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-label": "https://esm.sh/@radix-ui/react-label@2.1.1?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-scroll-area": "https://esm.sh/@radix-ui/react-scroll-area@1.2.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-context-menu": "https://esm.sh/@radix-ui/react-context-menu@2.2.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-menubar": "https://esm.sh/@radix-ui/react-menubar@1.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-navigation-menu": "https://esm.sh/@radix-ui/react-navigation-menu@1.2.3?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-collapsible": "https://esm.sh/@radix-ui/react-collapsible@1.1.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-toggle": "https://esm.sh/@radix-ui/react-toggle@1.1.1?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-toggle-group": "https://esm.sh/@radix-ui/react-toggle-group@1.1.1?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-radio-group": "https://esm.sh/@radix-ui/react-radio-group@1.2.2?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-hover-card": "https://esm.sh/@radix-ui/react-hover-card@1.1.4?deps=react@18.3.1,react-dom@18.3.1",
      "@radix-ui/react-aspect-ratio": "https://esm.sh/@radix-ui/react-aspect-ratio@1.1.1?deps=react@18.3.1,react-dom@18.3.1",
      ...
      "react-datepicker": "https://esm.sh/react-datepicker@7.5.0?deps=react@18.3.1,react-dom@18.3.1",
      ...
      // ✅ Table
      "@tanstack/react-table": "https://esm.sh/@tanstack/react-table@8.20.5?deps=react@18.3.1,react-dom@18.3.1",
      "react-table": "https://esm.sh/react-table@7.8.0?deps=react@18.3.1,react-dom@18.3.1",
      ...
      "sonner": "https://esm.sh/sonner@1.7.2?deps=react@18.3.1,react-dom@18.3.1",
      "react-toastify": "https://esm.sh/react-toastify@10.0.6?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ Maps
      "leaflet": "https://esm.sh/leaflet@1.9.4",
      "react-leaflet": "https://esm.sh/react-leaflet@4.2.1?deps=react@18.3.1,react-dom@18.3.1",
      "mapbox-gl": "https://esm.sh/mapbox-gl@3.9.2",

      // ✅ Rich Text / Editor
      "@tiptap/react": "https://esm.sh/@tiptap/react@2.10.4?deps=react@18.3.1,react-dom@18.3.1",
      "@tiptap/starter-kit": "https://esm.sh/@tiptap/starter-kit@2.10.4",
      "react-quill": "https://esm.sh/react-quill@2.0.0?deps=react@18.3.1,react-dom@18.3.1",
      "slate": "https://esm.sh/slate@0.110.2",
      "slate-react": "https://esm.sh/slate-react@0.110.1?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ Markdown
      "react-markdown": "https://esm.sh/react-markdown@9.0.1?deps=react@18.3.1,react-dom@18.3.1",
      ...
      // ✅ File Upload
      "react-dropzone": "https://esm.sh/react-dropzone@14.3.5?deps=react@18.3.1,react-dom@18.3.1",

      // ✅ Virtual List
      "react-window": "https://esm.sh/react-window@1.8.10?deps=react@18.3.1,react-dom@18.3.1",
      "react-virtualized": "https://esm.sh/react-virtualized@9.22.5?deps=react@18.3.1,react-dom@18.3.1",
      "@tanstack/react-virtual": "https://esm.sh/@tanstack/react-virtual@3.11.2?deps=react@18.3.1,react-dom@18.3.1",
      ...
      "react-konva": "https://esm.sh/react-konva@18.2.10?deps=react@18.3.1,react-dom@18.3.1",
      ...
      "zustand/middleware": "https://esm.sh/zustand@4.5.5/middleware?deps=react@18.3.1,react-dom@18.3.1",
    };
    ...
    if (hasReact) {
      ...
      files.find(f => (f.startsWith(workspacePrefix) || f.startsWith('src/')) && (f.includes('components/') || f.includes('pages/'))) ||
      files.find(f => (f.startsWith(workspacePrefix) || f.startsWith('src/')) && f.split('/').pop()![0] === f.split('/').pop()![0].toUpperCase()) ||
      files.find(f => f.startsWith(workspacePrefix) || f.startsWith('src/'));
      ...
      if (entryFile) {
        ...
        bootstrapScript = entrySelfBootstraps
          ? `
            <script type="module">
              console.log('BOOTSTRAP: Self-bootstrapping from ${importSpecifier}');
          ...
          : `
            <script type="module">
              ...
              const init = () => {
                console.log('BOOTSTRAP: Initializing from ${importSpecifier}');
                const rootElement = document.getElementById('root') || document.getElementById('app') || document.body;
                const isSplashScreen = rootElement.innerHTML.includes('animate-pulse') || rootElement.innerHTML.includes('Ready to Build');
                if (rootElement && (rootElement.innerHTML.trim().length < 100 || isSplashScreen)) {
                  const App = Main.default || Object.values(Main).find(v => typeof v === 'function' && v.name && v.name[0] === v.name[0].toUpperCase());
                  if (App) {
                    try {
                      console.log('BOOTSTRAP: Rendering App component');
                      if (isSplashScreen) rootElement.innerHTML = '';
                      const root = createRoot(rootElement);
                      root.render(React.createElement(App));
                    } catch (e) { console.error('Bootstrap Error:', e); }
                  } else {
                    console.warn('BOOTSTRAP: No App component found in ${importSpecifier}');
                  }
                }
              };
        ...
        console.warn('BOOTSTRAP: No entry file found among:', files);
      }
    }
